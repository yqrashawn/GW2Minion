...
wt_core_dungeonmanager.wnd = { name = "DungeonManager", x = 350, y = 100, w = 280, h = 140}
...
RegisterEventHandler("Module.Initalize",
	function (DMGR)				
		...
		GUI_NewField(wt_core_dungeonmanager.wnd.name,"Status","dStatus")
		GUI_NewField(wt_core_dungeonmanager.wnd.name,"PartySize","dPartysize")
		...
		local id,name = next(wt_core_dungeonmanager.Instances)
			while id~=nil and name~=nil do
				GUI_NewButton(wt_core_dungeonmanager.wnd.name, tostring(name),tostring(id))
...
RegisterEventHandler("wt_core_dungeonmanager.toggle", 
	function ()
