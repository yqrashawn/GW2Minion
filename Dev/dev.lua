...
function dev.DrawGadgetDetails(c)
	...
	GUI:BulletText("Type") GUI:SameLine(200) GUI:InputText("##devg4",tostring(c.contentid2),GUI.InputTextFlags_ReadOnly+GUI.InputTextFlags_AutoSelectAll)
	GUI:BulletText("Type2") GUI:SameLine(200) GUI:InputText("##devg5",tostring(c.contentid2),GUI.InputTextFlags_ReadOnly+GUI.InputTextFlags_AutoSelectAll)
