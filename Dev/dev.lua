...
-- COMPASS
			if ( GUI:TreeNode("Compass") ) then
				...
				if (t) then
					...
					GUI:BulletText("Scale X") GUI:SameLine(200) GUI:InputText("##devcmp3",tostring(t.x),GUI.InputTextFlags_ReadOnly+GUI.InputTextFlags_AutoSelectAll)
					GUI:BulletText("Scale Y") GUI:SameLine(200) GUI:InputText("##devcmp4",tostring(t.y),GUI.InputTextFlags_ReadOnly+GUI.InputTextFlags_AutoSelectAll)
					...
					GUI:BulletText("LookAt X") GUI:SameLine(200) GUI:InputText("##devcmp12",tostring(t.lookat.x),GUI.InputTextFlags_ReadOnly+GUI.InputTextFlags_AutoSelectAll)
					GUI:BulletText("LookAt Y") GUI:SameLine(200) GUI:InputText("##devcmp13",tostring(t.lookat.y),GUI.InputTextFlags_ReadOnly+GUI.InputTextFlags_AutoSelectAll)
					GUI:BulletText("LookAt Z") GUI:SameLine(200) GUI:InputText("##devcmp14",tostring(t.lookat.z),GUI.InputTextFlags_ReadOnly+GUI.InputTextFlags_AutoSelectAll)
					GUI:BulletText("Eye X") GUI:SameLine(200) GUI:InputText("##devcmp15",tostring(t.eye.x),GUI.InputTextFlags_ReadOnly+GUI.InputTextFlags_AutoSelectAll)
					GUI:BulletText("Eye Y") GUI:SameLine(200) GUI:InputText("##devcmp16",tostring(t.eye.y),GUI.InputTextFlags_ReadOnly+GUI.InputTextFlags_AutoSelectAll)
					GUI:BulletText("Eye Z") GUI:SameLine(200) GUI:InputText("##devcmp17",tostring(t.eye.z),GUI.InputTextFlags_ReadOnly+GUI.InputTextFlags_AutoSelectAll)
				end
				GUI:PopItemWidth()
				GUI:TreePop()
			end
