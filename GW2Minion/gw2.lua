...
function gw2minion.Init()
	...
	if ( ml_mesh_mgr ) then 
		...
		ml_mesh_mgr.SetDefaultMesh(15,"Queensdale",true)
		ml_mesh_mgr.SetDefaultMesh(17,"Harathi Hinterlands",true)
		ml_mesh_mgr.SetDefaultMesh(19,"PlainsOfAshford",true)
		ml_mesh_mgr.SetDefaultMesh(20,"BlazzeridgeSteppes",true)
		ml_mesh_mgr.SetDefaultMesh(21,"Fields of Ruin",true)
		ml_mesh_mgr.SetDefaultMesh(22,"FireHeartRise",true)		
		ml_mesh_mgr.SetDefaultMesh(23,"Kessex Hills",true)		
		ml_mesh_mgr.SetDefaultMesh(24,"Gendarran Fields",true)
		ml_mesh_mgr.SetDefaultMesh(25,"IronMarches",true)
		ml_mesh_mgr.SetDefaultMesh(26,"Dredgehaunt Cliffs",true)
		ml_mesh_mgr.SetDefaultMesh(27,"LonarsPass",true)
		ml_mesh_mgr.SetDefaultMesh(28,"Wayfarer Foothills",true)		
		ml_mesh_mgr.SetDefaultMesh(29,"TimberlineFalls",true)
		ml_mesh_mgr.SetDefaultMesh(30,"FrostGorge Sound",true)
		ml_mesh_mgr.SetDefaultMesh(31,"Snowden Drifts",true)		
		ml_mesh_mgr.SetDefaultMesh(32,"DiessaPlateau",true)
		ml_mesh_mgr.SetDefaultMesh(34,"Caledon Forest",true)
		ml_mesh_mgr.SetDefaultMesh(35,"MetricaProvince",true)
		ml_mesh_mgr.SetDefaultMesh(39,"MountMaelstrom",true)
		
		ml_mesh_mgr.SetDefaultMesh(51,"Straits of Devastation",true)
		ml_mesh_mgr.SetDefaultMesh(53,"Sparkfly Fen",true)
		ml_mesh_mgr.SetDefaultMesh(54,"Brisban Wildlands",true)
		
		ml_mesh_mgr.SetDefaultMesh(62,"CursedShore",true)
		ml_mesh_mgr.SetDefaultMesh(65,"Malchors Leap",true)
		ml_mesh_mgr.SetDefaultMesh(73,"BloodtideCoast",true)
		
		-- Lions Arch
		ml_mesh_mgr.SetDefaultMesh(50,"Lions Arch",true)
		-- Black Citadel
		ml_mesh_mgr.SetDefaultMesh(218,"Black Citadel",true)
		ml_mesh_mgr.SetDefaultMesh(371,"Heros Canton",true)
		ml_mesh_mgr.SetDefaultMesh(833,"Ash Tribune Quarters",true)
		ml_mesh_mgr.SetDefaultMesh(460,"Citadel Stockade",true)
		ml_mesh_mgr.SetDefaultMesh(372,"Blood Tribune Quarters",true)
		ml_mesh_mgr.SetDefaultMesh(373,"The Command Core",true)
		-- Divitnity's Reach
		ml_mesh_mgr.SetDefaultMesh(18,"Divinitys Reach",true)
		ml_mesh_mgr.SetDefaultMesh(378,"Queens Throne Room",true)
		ml_mesh_mgr.SetDefaultMesh(248,"Salma District (Home)",true)
		ml_mesh_mgr.SetDefaultMesh(914,"The Dead End",true)
		ml_mesh_mgr.SetDefaultMesh(330,"Seraph Headquarters",true)
		-- Hoelbrak
		ml_mesh_mgr.SetDefaultMesh(326,"Hoelbrak",true)
		ml_mesh_mgr.SetDefaultMesh(374,"Knut Whitebears Loft",true)
		ml_mesh_mgr.SetDefaultMesh(375,"Hunters Hearth (Home)",true)
		ml_mesh_mgr.SetDefaultMesh(376,"Stonewrights Steading",true)
		-- Rata Sum
		ml_mesh_mgr.SetDefaultMesh(139,"Rata Sum",true)
		ml_mesh_mgr.SetDefaultMesh(650,"Applied Development Lab (Home)",true)
		ml_mesh_mgr.SetDefaultMesh(651,"Council Level",true)
		ml_mesh_mgr.SetDefaultMesh(649,"Snaff Memorial Lab",true)
		-- The Grove
		ml_mesh_mgr.SetDefaultMesh(91,"The Grove",true)
		ml_mesh_mgr.SetDefaultMesh(647,"Dreamers Terrace (Home)",true)
		ml_mesh_mgr.SetDefaultMesh(646,"The House of Caithe",true)
		ml_mesh_mgr.SetDefaultMesh(648,"The Omphalos Chamber",true)

		ml_mesh_mgr.SetDefaultMesh(350,"Heart of the Mists",true)
		ml_mesh_mgr.SetDefaultMesh(968,"EdgeOfTheMist",true)
		ml_mesh_mgr.SetDefaultMesh(988,"Dry Top",true)
		--HoT
		ml_mesh_mgr.SetDefaultMesh(1052,"Verdant Brink",true)
		ml_mesh_mgr.SetDefaultMesh(1043,"Auric Basin",true)
		...
		--sPVP
		 ...
		 ml_mesh_mgr.SetDefaultMesh(1015,"SilverWastes",true)		 
		 ml_mesh_mgr.SetDefaultMesh(1041,"DragonStand",true)
		 ml_mesh_mgr.SetDefaultMesh(1045,"TangledDepths",true)
		 ml_mesh_mgr.SetDefaultMesh(1163,"sPvP Revenge of the Capricorn",true)		 
		 ml_mesh_mgr.SetDefaultMesh(1165,"Bloodstone Fen",true)
		 ml_mesh_mgr.SetDefaultMesh(1171,"sPvp Coloseum",true)
		 ml_mesh_mgr.SetDefaultMesh(1175,"Infernal Cape",true)
		 
		--Instances
		ml_mesh_mgr.SetDefaultMesh(896,"North Noland Hatchery",true) -- Diessa Plateau
	...
	if(ml_task_mgr) then
		...
		ml_task_mgr.AddSubTaskType("tm_st_killspecific", "tm_CombatHandler.st", nil, {displayname = GetString("Kill specific")})
