...
function gw2_buy_manager.ModuleInit()
	...
	if (Settings.gw2_buy_manager.toolList == nil) then
		Settings.gw2_buy_manager.toolList = {
			...
			currID = Player.level < 10 and 2 or Player.level < 20 and 3 or Player.level < 30 and 4 or Player.level < 45 and 5 or Player.level < 80 and 6 or 7, -- stupid fix for equip misusing buy options..... :(
		}
	end
