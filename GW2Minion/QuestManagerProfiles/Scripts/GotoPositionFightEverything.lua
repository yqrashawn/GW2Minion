...
script.name = "GotoPositionFightEverything"
script.Data = {}
...
function script:Init()
	...
	-- Kill Stuff Nearby
	self:add(ml_element:create( "SearchAndKillNearby", c_SearchAndKillNearby, e_SearchAndKillNearby, 110 ), self.process_elements)	
	
	-- GoTo Position
	self:add(ml_element:create( "GoToPosition", self.c_goto, self.e_goto, 100 ), self.process_elements)	
